sap.ui.define(['sap/ui/core/mvc/ControllerExtension'], function (ControllerExtension) {
	...
	function setWidth() {
		var oSmartTable = sap.ui.getCore().byId(
			"cashflowcontractinitial::ContractObjectPage--fe::table::contractToCondition::LineItem::ConditionItems4"
		);
			...
			routing: {
				...
				onAfterBinding: function () {
					...
					const oDisplayField = sap.ui.getCore().byId(
						"cashflowcontractinitial::ContractObjectPage--fe::FormContainer::Fixed::FormElement::DataField::fixedFrom::Field-display"
					);

					const oDatePicker1 = sap.ui.getCore().byId(
						"cashflowcontractinitial::ContractObjectPage--fe::FormContainer::Fixed::FormElement::DataField::fixedUntil::Field-edit"
					);
					const oDisplayField1 = sap.ui.getCore().byId(
						"cashflowcontractinitial::ContractObjectPage--fe::FormContainer::Fixed::FormElement::DataField::fixedUntil::Field-display"
					);
