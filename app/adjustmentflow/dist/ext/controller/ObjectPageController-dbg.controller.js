sap.ui.define(['sap/ui/core/mvc/ControllerExtension'], function (ControllerExtension) {
	...
	function setWidth() {
		var oSmartTable = sap.ui.getCore().byId("adjustmentflow::contractAdjustObjectPage--fe::table::contractToConditionAdjust::LineItem::ConditionItems")
	...
	return ControllerExtension.extend('adjustmentflow.ext.controller.ObjectPageController', {
		// this section allows to extend lifecycle hooks or hooks provided by Fiori elements
		override: {
			/**
			 * Called when a controller is instantiated and its View controls (if available) are already created.
			 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
			 * @memberOf adjustmentflow.ext.controller.ObjectPageController
			 */
			onInit: function () {
			...
			routing: {
				onAfterBinding: function () {
					...
					const oDatePicker = sap.ui.getCore().byId(
						"adjustmentflow::contractAdjustObjectPage--fe::FormContainer::GeneratedFacet1::FormElement::DataField::fixedFrom::Field-edit"
					);
					const oDisplayField = sap.ui.getCore().byId(
						"adjustmentflow::contractAdjustObjectPage--fe::FormContainer::GeneratedFacet1::FormElement::DataField::fixedFrom::Field-display"
					);

					const oDatePicker1 = sap.ui.getCore().byId(
						"adjustmentflow::contractAdjustObjectPage--fe::FormContainer::GeneratedFacet1::FormElement::DataField::fixedUntil::Field-edit"
					);
					const oDisplayField1 = sap.ui.getCore().byId(
						"adjustmentflow::contractAdjustObjectPage--fe::FormContainer::GeneratedFacet1::FormElement::DataField::fixedUntil::Field-display"
					);
					...
					function formatDateColumn() {
						const oFacet = sap.ui.getCore().byId(
							"adjustmentflow::contractAdjustObjectPage--fe::FacetSubSection::ConditionItems"
						);
