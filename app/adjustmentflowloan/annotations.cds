...
annotate service.contractAdjustLoan with @(
...
annotate service.ConditionItemsAdjustLoan with @(UI.LineItem #ConditionItems: [
    {
        $Type: 'UI.DataField',
...
annotate service.ConditionItemsAdjustLoan with {
    paymentFromExactDay @(
        Common.ValueList               : {
